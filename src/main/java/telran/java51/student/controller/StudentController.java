...
public class StudentController {
	...
	public StudentCreateDto updateStudent(@PathVariable Integer id,
	...
	public List<StudentDto> getStudentsByExamMinScore(@PathVariable String exam,
